    ...
    <section className="py-20 pt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="bg-primary/10 backdrop-blur-sm border border-primary/20 rounded-xl p-6 hover:border-primary/40 transition-all duration-300">
              ...
              <p className="text-slate-400 text-sm">Modern development practices, frameworks, and best practices</p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-secondary/10 backdrop-blur-sm border border-secondary/20 rounded-xl p-6 hover:border-secondary/40 transition-all duration-300">
              ...
              <p className="text-slate-400 text-sm">Entrepreneurial insights, market analysis, and growth strategies</p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-green-500/10 backdrop-blur-sm border border-green-400/20 rounded-xl p-6 hover:border-green-400/40 transition-all duration-300">
              ...
              <p className="text-slate-400 text-sm">Personal development, team building, and career advancement</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-gray-400 text-sm">Available Access</div>
          </div>
        </motion.div>
        ...
        >
          <div className="inline-flex items-center space-x-6 bg-slate-800/70 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8">
            <div className="text-5xl">🚀</div>
            <div className="text-left">
              <div className="text-xl font-semibold text-white mb-2">Ready to Level Up?</div>
              <div className="text-slate-400">Explore curated learning paths and actionable insights</div>
            </div>
            <a
