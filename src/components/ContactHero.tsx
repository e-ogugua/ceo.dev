      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/30 rounded-lg p-4 text-center hover:border-blue-400/30 transition-all duration-300 hover:bg-slate-800/50"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/30 rounded-lg p-4 text-center hover:border-green-400/30 transition-all duration-300 hover:bg-slate-800/50"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/30 rounded-lg p-4 text-center hover:border-purple-400/30 transition-all duration-300 hover:bg-slate-800/50"
          >
            <div className="w-8 h-8 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
              <Clock className="w-4 h-4 text-purple-400" />
            </div>
            <h3 className="font-semibold text-white mb-1 text-sm">Available</h3>
            <p className="text-slate-400 text-xs">Global Time Zones</p>
          </motion.div>
        </div>
      </div>
    </section>
