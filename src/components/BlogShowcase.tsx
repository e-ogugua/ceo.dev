          ...
          >
            ...
            <div className="flex gap-3">
              <Link href="https://ceowrites-emmanuel-blog-hub.vercel.app/" target="_blank">
                <motion.button
                  className="bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white px-4 py-2 rounded text-sm font-semibold flex items-center gap-2 transition-all duration-200"
