...
export function PersonaChart() {
  return (
    <section className="py-12 bg-slate-50/20 dark:bg-slate-900/30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          >
            <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm border border-slate-200/70 dark:border-slate-700/70 rounded-lg p-5 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Software Engineer</h3>
              ...
              <div className="p-2 bg-slate-50/80 dark:bg-slate-700/60 rounded border border-slate-200/50 dark:border-slate-600/50">
                <p className="text-slate-800 dark:text-slate-200 text-xs italic">
          ...
          >
            <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm border border-slate-200/70 dark:border-slate-700/70 rounded-lg p-5 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Business Strategist</h3>
